...
Idle time (IT) can be measured in different ways, but the common theme is that we compare the time when tools are actively used ($T_a$) with the total task time $T$.
